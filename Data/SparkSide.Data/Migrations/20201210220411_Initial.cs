    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SiteAlerts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SiteAlerts_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SiteAlerts_AspNetUsers_AuthorId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersFollows_AspNetUsers_FollowedId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengesTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChallengesTags_Challenges_ChallengeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersChallengesActive", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersChallengesFavourite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersChallengesFavourite_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengesTags_ChallengeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersChallengesFavourite_IsDeleted",
                table: "UsersChallengesFavourite",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersFollows_IsDeleted",
                table: "UsersFollows",
                column: "IsDeleted");
        }
